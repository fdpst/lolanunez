...
watch(
    ...
    () => {
        ...
        isCookieHasAnyValue.value =
            JSON.stringify(themeConfigValue) !==
            JSON.stringify(initialConfigValue);
    },
    {
        deep: true,
        immediate: true
...
const resetCustomizer = async () => {
    if (isCookieHasAnyValue.value) {
        ...
        vuetifyTheme.themes.value.light.colors[
            "primary-darken-1"
        ] = staticPrimaryDarkenColor;
        vuetifyTheme.themes.value.dark.colors[
            "primary-darken-1"
        ] = staticPrimaryDarkenColor;
    ...
    <div class="d-lg-block d-none">
        ...
        >
            ...
            >
                <div>
                    ...
                    <p class="text-body-2 mb-0">
                        Personaliza y ve una vista previa en tiempo real
                    </p>
                </div>
            ...
            <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
                <!-- SECTION Theming -->
                <CustomizerSection title="Tematización" :divider="false">
                    <!-- 👉 Primary Color -->
