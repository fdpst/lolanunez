import{V as d}from"./VSwitch-DKzwibPO.js";import{r as m,o as w,c as v,b as l,n as a,ag as p,f,e as r,v as c,av as O,d as i,x as L,F as b,i as y}from"./main-C1cSucNj.js";import{_ as $}from"./AppCardCode-DshpRWUE.js";import{V as D,a as S}from"./VRow-DdYzItfl.js";import"./VInput-wvAgDqIB.js";import"./form-BJwA8ai1.js";import"./VSelectionControl-CM7Gd7lS.js";import"./VCard-DoJ7OvEk.js";import"./VAvatar-BpNw3P6_.js";import"./VImg-D1aAeOw8.js";import"./VCardText-iOQ31nyo.js";import"./VDivider-BS9Tllbl.js";/* empty css              */const U={class:"demo-space-x"},C={__name:"DemoSwitchStates",setup(h){const t=m("on"),e=m("on"),n=m(!0);return(s,o)=>(w(),v("div",U,[l(d,{modelValue:a(t),"onUpdate:modelValue":o[0]||(o[0]=u=>p(t)?t.value=u:null),value:"on",label:"On"},null,8,["modelValue"]),l(d,{label:"Off"}),l(d,{modelValue:a(e),"onUpdate:modelValue":o[1]||(o[1]=u=>p(e)?e.value=u:null),value:"on",disabled:"",label:"On disabled"},null,8,["modelValue"]),l(d,{disabled:"",label:"Off disabled"}),l(d,{modelValue:a(n),"onUpdate:modelValue":o[2]||(o[2]=u=>p(n)?n.value=u:null),loading:"warning",label:`${a(n)?"On":"Off"} loading`},null,8,["modelValue","label"])]))}},T={class:"demo-space-x"},J={__name:"DemoSwitchTrueAndFalseValue",setup(h){const t=m(1),e=m("Show");return(n,s)=>(w(),v("div",T,[l(d,{modelValue:a(t),"onUpdate:modelValue":s[0]||(s[0]=o=>p(t)?t.value=o:null),label:a(t).toString(),"true-value":1,"false-value":0},null,8,["modelValue","label"]),l(d,{modelValue:a(e),"onUpdate:modelValue":s[1]||(s[1]=o=>p(e)?e.value=o:null),label:a(e).toString(),"true-value":"Show","false-value":"Hide"},null,8,["modelValue","label"])]))}},A={__name:"DemoSwitchLabelSlot",setup(h){const t=m(!1);return(e,n)=>(w(),f(d,{modelValue:a(t),"onUpdate:modelValue":n[0]||(n[0]=s=>p(t)?t.value=s:null)},{label:r(()=>[n[1]||(n[1]=c(" Turn on the progress: ")),l(O,{indeterminate:a(t),size:"24",class:"ms-2"},null,8,["indeterminate"])]),_:1},8,["modelValue"]))}},F={class:"demo-space-x"},M={class:"mt-2 mb-0"},z={__name:"DemoSwitchModelAsArray",setup(h){const t=m(["John"]);return(e,n)=>(w(),v(b,null,[i("div",F,[l(d,{modelValue:a(t),"onUpdate:modelValue":n[0]||(n[0]=s=>p(t)?t.value=s:null),label:"John",value:"John"},null,8,["modelValue"]),l(d,{modelValue:a(t),"onUpdate:modelValue":n[1]||(n[1]=s=>p(t)?t.value=s:null),label:"Jacob",value:"Jacob"},null,8,["modelValue"])]),i("p",M,L(a(t)),1)],64))}},I={class:"demo-space-x"},P={__name:"DemoSwitchColors",setup(h){const t=m(["Primary","Secondary","Success","Info","Warning","Error"]),e=m(["Primary","Secondary","Success","Info","Warning","Error"]);return(n,s)=>(w(),v("div",I,[(w(!0),v(b,null,y(a(e),o=>(w(),f(d,{key:o,modelValue:a(t),"onUpdate:modelValue":s[0]||(s[0]=u=>p(t)?t.value=u:null),label:o,value:o,color:o.toLowerCase()},null,8,["modelValue","label","value","color"]))),128))]))}},j={class:"demo-space-x"},B={__name:"DemoSwitchInset",setup(h){const t=m(!0),e=m(!1);return(n,s)=>(w(),v("div",j,[l(d,{modelValue:a(t),"onUpdate:modelValue":s[0]||(s[0]=o=>p(t)?t.value=o:null),inset:!1,label:`Switch 1: ${a(t).toString()}`},null,8,["modelValue","label"]),l(d,{modelValue:a(e),"onUpdate:modelValue":s[1]||(s[1]=o=>p(e)?e.value=o:null),inset:!1,label:`Switch 2: ${a(e).toString()}`},null,8,["modelValue","label"])]))}},E={class:"demo-space-x"},k={__name:"DemoSwitchBasic",setup(h){const t=m(!0),e=m(!1),n=s=>{const o=s.toString();return o.charAt(0).toUpperCase()+o.slice(1)};return(s,o)=>(w(),v("div",E,[l(d,{modelValue:a(t),"onUpdate:modelValue":o[0]||(o[0]=u=>p(t)?t.value=u:null),label:n(a(t))},null,8,["modelValue","label"]),l(d,{modelValue:a(e),"onUpdate:modelValue":o[1]||(o[1]=u=>p(e)?e.value=u:null),label:n(a(e))},null,8,["modelValue","label"])]))}},W={ts:`<script lang="ts" setup>
