import{V as s}from"./VFileInput-xsSW0eDK.js";import{r as f,w as D,o as c,f as u,n as F,ag as V,e as i,c as j,F as S,i as N,v as t,x as L,b as e,d as l}from"./main-XhKa_9tU.js";import{V as U}from"./VChip-BBE3Enfq.js";import{_ as m}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{a as p,V as b}from"./VRow-CFasNknx.js";import{_ as k}from"./AppCardCode-BWgbS9V9.js";import"./VField-CvyOoNAD.js";import"./form-BsyuclTd.js";import"./VInput-DCf9aRQz.js";import"./VCounter-zOsFyD3o.js";import"./VAvatar-BgIHgX1n.js";import"./VImg-BWevH90G.js";/* empty css              */import"./VCard-Eaj0dfV-.js";import"./VCardText-B_O88IhU.js";import"./VDivider-C4lH0ooT.js";const A={__name:"DemoFileInputLoading",setup(r){const o=f(),n=f(!0);return D(o,()=>{n.value=!o.value[0]}),(d,a)=>(c(),u(s,{modelValue:F(o),"onUpdate:modelValue":a[0]||(a[0]=_=>V(o)?o.value=_:null),loading:F(n),color:"primary",label:"File input"},null,8,["modelValue","loading"]))}},B={__name:"DemoFileInputSelectionSlot",setup(r){const o=f([]);return(n,d)=>(c(),u(s,{modelValue:F(o),"onUpdate:modelValue":d[0]||(d[0]=a=>V(o)?o.value=a:null),multiple:"",placeholder:"Upload your documents",label:"File input","prepend-icon":"ri-attachment-line"},{selection:i(({fileNames:a})=>[(c(!0),j(S,null,N(a,_=>(c(),u(U,{key:_,label:"",size:"small",variant:"outlined",color:"primary",class:"me-2"},{default:i(()=>[t(L(_),1)]),_:2},1024))),128))]),_:1},8,["modelValue"]))}},P={__name:"DemoFileInputValidation",setup(r){const o=[n=>!n||!n.length||n[0].size<1e6||"Avatar size should be less than 1 MB!"];return(n,d)=>(c(),u(s,{rules:o,label:"Avatar",accept:"image/png, image/jpeg, image/bmp",placeholder:"Pick an avatar","prepend-icon":"ri-camera-2-line"}))}},R={};function M(r,o){return c(),u(s,{"show-size":"",label:"File input"})}const T=m(R,[["render",M]]),O={};function Y(r,o){return c(),u(s,{label:"File input","prepend-icon":"ri-camera-line"})}const E=m(O,[["render",Y]]),W={};function q(r,o){return c(),u(s,{multiple:"",label:"File input"})}const G=m(W,[["render",q]]),H={};function J(r,o){return c(),u(s,{"show-size":"",counter:"",multiple:"",label:"File input"})}const K=m(H,[["render",J]]),Q={};function X(r,o){return c(),u(s,{chips:"",label:"File input w/ chips"})}const Z=m(Q,[["render",X]]),ee={};function le(r,o){return c(),u(s,{accept:"image/*",label:"File input"})}const te=m(ee,[["render",le]]),ne={};function ie(r,o){return c(),u(b,null,{default:i(()=>[e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Outlined"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Filled",variant:"filled"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Solo",variant:"solo"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Plain",variant:"plain"})]),_:1}),e(p,{cols:"12",sm:"6"},{default:i(()=>[e(s,{label:"Underlined",variant:"underlined"})]),_:1})]),_:1})}const oe=m(ne,[["render",ie]]),ae={};function pe(r,o){return c(),u(s,{label:"File input",density:"compact"})}const se=m(ae,[["render",pe]]),ce={};function ue(r,o){return c(),u(s,{label:"File input"})}const re=m(ce,[["render",ue]]),me={ts:`<template>
  <VFileInput
    accept="image/*"
    label="File input"
  />
